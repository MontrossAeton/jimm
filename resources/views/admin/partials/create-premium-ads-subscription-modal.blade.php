<div class="modal fade" id="create-subscription-modal" tabindex="-1" role="dialog" aria-labelledby="create-subscription-modal-label" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('admin.subscriptions.premium-ads-subscription') }}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="type" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" required>
                                <option value="monthly">Monthly (₱ 801.30)</option>
                                <option value="year_1">1 Year (₱ 9615.60)</option>
                            </select>
                        </div>
                        @if ($errors->has('type'))
